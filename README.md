...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>亮色、暗色、跟随系统；内置 13 套毛玻璃渐变和 9 套护眼纯色方案，保存选中状态；渐变方案使用半透明玻璃卡片，护眼方案使用综合色相更明确的纯色背景与不透明卡片，背景、遮罩、卡片尺寸和图标大小都可配置</td>
    </tr>
    <tr>
...
> 🎨 内置 22 套跨色系模板：13 套毛玻璃渐变自动带入推荐遮罩和卡片透明度，9 套护眼纯色使用加深的低饱和前台背景与不透明卡片；每套均提供亮色和暗色配置，仍可继续改成纯色、渐变或图片背景。
>
