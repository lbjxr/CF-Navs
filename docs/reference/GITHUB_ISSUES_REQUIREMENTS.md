...
| R-08 | 部分导出备份，便于多个项目同步维护 | Enhancement | 已发版；非空子分类导出与追加/覆盖回导在临时本地库通过，生产只读验收完成；复杂生产样本仍由 PROB-14 跟踪；#9 已按批准范围关闭 | [#9](https://github.com/lbjxr/CF-Navs/issues/9)、[#8](https://github.com/lbjxr/CF-Navs/issues/8) |
